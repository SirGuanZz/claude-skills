...
| Skill | 触发 | 关注点 |
|-------|------|--------|
| [`vue-fe-review`](./vue-fe-review) | `/vue-fe-review`、"review 一下"、"前端审一下"、"这代码有啥问题"、"检查内存泄漏" | **代码错误 + 加载速度 + 内存泄漏**：响应式陷阱 / SSR 反模式 / 路由 404 / 请求瀑布 / 首屏包体积 / 未清理的监听器与定时器 / 大列表 / 深响应式大对象；一轮 + 自省一次后收口 |
